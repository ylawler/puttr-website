...
function Hero() {
  const { heading, subheading, centerImageSrc } = heroDetails;
  return (
    <section
      id="hero"
      className="relative flex items-center justify-center pb-0 pt-20 md:pt-36 px-5"
    >
      ...
      <div className="text-center">
        ...
        <p className="mt-5 text-foreground max-w-lg mx-auto">{subheading}</p>
        <div className="mt-6 flex flex-col sm:flex-row items-center sm:gap-4 w-fit mx-auto">
          <AppStoreButton variant={"dark"} />
          {/* <PlayStoreButton variant={"dark"} /> */}
        </div>
        <Image
          src={centerImageSrc}
          width={384}
          ...
          unoptimized={true}
          alt="app mockup"
          className="relative mt-6 md:mt-10 mx-auto z-10"
        />
      </div>
    </section>
  );
